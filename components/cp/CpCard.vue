...
<template>
  ...
  >
    ...
    <a :href="cp.url" target="_new" rel="norel noopener" class="el-button el-button--primary w-full flex items-center">
      <i class="el-icon-link mr-2"></i>Visit
    </a>
    <el-button icon="el-icon-check" class="absolute top-4 right-4" size="small" plain />
  </div>
</template>